...
void init_PointMassMPI() {
	...
	MPI_Datatype types[count] = {PointMPI, MPI_DOUBLE};
...
void init_CellMPI() {
	...
	MPI_Aint displacements[count] = {0, 16, 24, 24 + sizeof(Point)};
	MPI_Datatype types[count] = {MPI_INT, MPI_DOUBLE, PointMPI, PointMassMPI};
